...
MockCollection.prototype.onOpen = function () {
  var that = this;
  that.debug && console.log('MockCollection.onOpen :', arguments);
...
MockCollection.prototype.onClose = function () {
  var that = this;
  that.debug && console.log('MockCollection.onClose :', arguments);
  MongooseCollection.prototype.onClose.call(this);
};

MockCollection.prototype.getIndexes = function () {
  var that = this;
  that.debug && console.log('MockCollection.getIndexes :', arguments);
};
